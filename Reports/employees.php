...
<title>OpsFlow | Employee Report</title>
...
<a class="btn btn-primary" href="exports/export_employees.php">
...
<td>
<?php echo htmlspecialchars((string)($r['position'] ?? '—'));
 
?></td>

<td>
<?php echo htmlspecialchars((string)($r['email'] ?? '—'));
