...
<td><?php echo htmlspecialchars((string)($r['check_in'] ?? '—')); ?></td>
<td><?php echo htmlspecialchars((string)($r['check_out'] ?? '—')); ?></td>
