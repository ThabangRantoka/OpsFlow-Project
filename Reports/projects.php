...
<td><?php echo htmlspecialchars((string)($r['project_code'] ?? '—')); ?></td>
<td><?php echo htmlspecialchars((string)($r['project_name'] ?? '—')); ?></td>
<td><?php echo htmlspecialchars((string)($r['department'] ?? '—')); ?></td>
<td><?php echo htmlspecialchars((string)($r['project_manager'] ?? '—')); ?></td>
<td>R <?php echo number_format((float)$r['budget'],0,'.',' '); ?></td>
<td><div class="progress-track"><div class="progress-fill" style="width:<?php echo (int)$r['progress']; ?>%"></div></div><span class="small muted"><?php echo (int)$r['progress']; ?>%</span></td>
<td><?php echo htmlspecialchars((string)($r['priority'] ?? '—')); ?></td>
...
</tr><?php }}else{ ?><tr><td colspan="8"><div class="empty-state"><strong>No records found</strong>There is no data for this report yet.</div></td></tr><?php } ?></tbody></table></div></main></div></body></html>