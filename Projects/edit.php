...
value="
<?php echo htmlspecialchars($project["project_manager"]);
...
<option 
<?php if($project["priority"]=="Low") echo "selected";
 
?>>Low</option>


<option 
<?php if($project["priority"]=="Medium") echo "selected";
 
?>>Medium</option>


<option 
<?php if($project["priority"]=="High") echo "selected";
 
?>>High</option>


<option 
<?php if($project["priority"]=="Critical") echo "selected";
...
<option 
<?php if($project["status"]=="Planning") echo "selected";
...
<option 
<?php if($project["status"]=="On Hold") echo "selected";
